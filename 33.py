...
word = input("Введите сначало слово на русском языке: ").upper() 
count = 0
for i in word:
...
print(f'Стоимость русского слова: {count}')
...
print(f'Стоимость английского слова: {count}')
print(f'Слово с большей стоимость, является выигрышным!')
