...
a = int(input('Введите число, начало первого числа арифметической прогрессии: '))
n = int(input('Введите число, количество чисел в арифметической прогрессии: '))
d = int(input('Введите число, разность между элементами арифметической прогрессии: '))
progression = []
